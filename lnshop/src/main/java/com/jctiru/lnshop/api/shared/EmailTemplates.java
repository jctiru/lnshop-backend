...
public class EmailTemplates {
	...
	private static final String PASSWORD_RESET_REQUEST_SUBJECT = "Password Reset Request for LNShop";
	private static final String PASSWORD_RESET_REQUEST_HTML_BODY = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\"><head style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><meta name=\"viewport\" content=\"width=device-width\" style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><title style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\">LNShop</title></head><body bgcolor=\"#FFFFFF\" style=\"-webkit-font-smoothing:antialiased;-webkit-text-size-adjust:none;font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;height:100%;margin:0;padding:0;width:100%!important\"><style>@media only screen and (max-width:600px){a[class=btn]{display:block!important;margin-bottom:10px!important;background-image:none!important;margin-right:0!important}div[class=column]{width:auto!important;float:none!important}table.social div[class=column]{width:auto!important}}</style><table class=\"body-wrap\" style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0;width:100%\"><tbody><tr style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><td style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"></td><td class=\"container\" bgcolor=\"#DCDCDC\" style=\"clear:both!important;display:block!important;font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0 auto!important;max-width:600px!important;padding:0\"><div class=\"content\" style=\"display:block;font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0 auto;max-width:600px;padding:15px\"><table style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0;width:100%\"><tbody><tr style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><td style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"><h3 style=\"color:#000;font-family:HelveticaNeue-Light,'Helvetica Neue Light','Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:27px;font-weight:500;line-height:1.1;margin:0;margin-bottom:15px;padding:0\">Hi, $firstName!</h3><p class=\"lead\" style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;font-size:17px;font-weight:400;line-height:1.6;margin:0;margin-bottom:10px;padding:0\">You recently requested to reset your password for your account. Please click the link below to reset it.</p><p style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;line-height:1.6;margin:0;margin-bottom:10px;padding:0\">If you did not request a password reset, please ignore this email. The link below is only valid for 1 hour.</p><p class=\"callout\" style=\"background-color:#ECF8FF;font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;line-height:1.6;margin:0;margin-bottom:15px;padding:15px\">Please click the link next to me! <a href=\"$passwordResetRequestLink\" style=\"color:#2BA6CB;font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;font-weight:700;margin:0;padding:0\">Click it! »</a></p></td></tr></tbody></table></div></td><td style=\"font-family:'Helvetica Neue',Helvetica,Helvetica,Arial,sans-serif;margin:0;padding:0\"></td></tr></tbody></table></body></html>";
	private static final String PASSWORD_RESET_REQUEST_TEXT_BODY = "Hi, $firstName! You recently requested to reset your password for your account. Please click the link below to reset it. If you did not request a password reset, please ignore this email. The link below is only valid for 1 hour. Please click the link next to me! $passwordResetRequestLink";
	...
	public static String getPasswordResetRequestSubject() {
		return PASSWORD_RESET_REQUEST_SUBJECT;
	}

	public static List<String> getPasswordResetRequestHtmlAndTextBody(String firstName,
			String passwordResetRequestToken) {
		List<String> passwordResetRequestHtmlAndTextBody = new ArrayList<>();

		StringBuilder passwordResetRequestHtmlBody = new StringBuilder(PASSWORD_RESET_REQUEST_HTML_BODY);
		StringBuilder passwordResetRequestTextBody = new StringBuilder(PASSWORD_RESET_REQUEST_TEXT_BODY);

		Map<String, String> map = new HashMap<>();
		map.put("$firstName", firstName);
		map.put("$passwordResetRequestLink",
				staticAppProperties.getAppFrontendUrl() + "/password-reset-request?token=" + passwordResetRequestToken);

		for (Map.Entry<String, String> val : map.entrySet()) {
			EmailTemplates.replace(passwordResetRequestHtmlBody, val.getKey(), val.getValue());
			EmailTemplates.replace(passwordResetRequestTextBody, val.getKey(), val.getValue());
		}

		passwordResetRequestHtmlAndTextBody.add(passwordResetRequestHtmlBody.toString());
		passwordResetRequestHtmlAndTextBody.add(passwordResetRequestTextBody.toString());

		return passwordResetRequestHtmlAndTextBody;
	}
